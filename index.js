...
var app = express();
let routesEducationsCenters = require('./api/educations-centers/educationsCenters');
let routesEducationsCentersSecure = require('./api/educations-centers/educationsCentersSecure');

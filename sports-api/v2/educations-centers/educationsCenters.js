...
client.connect(err => {
    educationsCenters = client.db("sos1819-15dro").collection("educationsCenterV2");
...
function validation(newCompetitions) {
    ...
    if (newCompetitions.hasOwnProperty("id") &&
        ...
        newCompetitions.hasOwnProperty("yearStart") &&
...
function addData(res) {
    ...
    educationsCenters.insertMany([{
        ...
        },
        {
            ...
            , name: "Escuela Superior de Arte Dramático"
            , ownership: "Público"
